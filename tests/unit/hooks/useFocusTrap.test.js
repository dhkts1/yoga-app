...
describe('useFocusTrap', () => {
  ...
  describe('Disabled elements', () => {
    test('should skip disabled elements in focus trap', () => {
      ...
      expect(document.activeElement).toBe(containerWithDisabled.querySelector('#btn1'));
    ...
    test('should handle elements with tabindex="-1"', () => {
      ...
      expect(document.activeElement).toBe(containerWithTabindex.querySelector('#btn1'));
