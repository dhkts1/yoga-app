      ...
      >
        <ContentBody size="sm" spacing="none">
          ...
          <div className="-mt-6 mb-4 flex flex-col items-center justify-start text-center">
            ...
            <Heading level={1}>{greeting.text}</Heading>
          </div>
          ...
          {totalSessions > 0 && streakStatus.streak > 0 && (
            ...
            >
              ...
              <div className="flex space-x-0.5">
                {Array.from({ length: Math.min(streakStatus.streak, 3) }).map(
                  (_, i) => (
          ...
          {activeProgram ? (
            ...
            <div className="mb-6 w-full">
              <Text
                variant="body"
                className="mb-4 block font-medium text-muted-foreground"
              >
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between">
                  ...
                  {isRTL ? (
                    <ChevronRight className="rtl-flip size-5 text-muted-foreground" />
                  ) : (
            ...
            <div className="mb-6 w-full">
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  {isRTL ? (
                    <ChevronRight className="rtl-flip mt-1 size-5 shrink-0 text-accent" />
                  ) : (
                    <ChevronRight className="mt-1 size-5 shrink-0 text-accent" />
                  )}
                </div>
              </button>
            </div>
